...
class GsplatShaderEffect extends Script {
    ...
    /** @type {boolean} */
    shadersNeedApplication = false;

    /** @type {boolean} */
    needsRetry = false;

    /** @type {Function | null} */
    _materialCreatedHandler = null;

    /** @type {Map<import('playcanvas').Material, number> | null} */
    _materialLayers = null;
    ...
    removeShaders() {
        ...
        this.materialsApplied.forEach((mat) => {
            /** @type {any} */
            const material = mat;
    ...
    applyShaderToMaterial(material) {
        ...
        /** @type {any} */ (material).getShaderChunks(shaderLanguage).set('gsplatCustomizeVS', customShader);
        material.update();
    }
