...
class XrNavigation extends Script {
        ...
        if (!this.cameraEntity) {
            ...
            if (!this.cameraEntity) {
                for (const child of this.entity.children) {
                    ...
                    const childEntity = /** @type {any} */ (child);
                    if (childEntity.findComponent('camera')) {
    ...
    tryTeleport(inputSourceItem) {
        /** @type {any} */
        const inputSource = inputSourceItem;
    ...
    handleSmoothLocomotion(dt) {
        ...
        for (const inputSourceItem of this.inputSources) {
            /** @type {any} */
            const inputSource = inputSourceItem;
    ...
    handleSnapTurning(inputSourceItem) {
        /** @type {any} */
        const inputSource = inputSourceItem;
